...
namespace MatrimonialProject.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(IFormFile file, string returnUrl = null)
        {
            ...
            {
                var user = new ApplicationUser { UserName = Input.Email, Email = Input.Email, Name=Input.Name, City=Input.City, 
                    BirthDate=Input.BirthDate, Age=Input.Age,Cast=Input.Cast, Gender=Input.Gender, 
                    Relegion= Input.Relegion, Salay=Input.Salay, Ocupations=Input.Ocupations, 
                    MatrialStatus=Input.MatrialStatus, ImagePath=file.FileName};
